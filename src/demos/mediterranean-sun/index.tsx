...
/**
 * 地中海陽光 — Mediterranean Sun
 *
 * 角落旅行社 demo #01。完整 5 view 小網站：
 *   home → listing → detail → itinerary → signup
 *
 * 靈感：Aman Costa Brava、Villa Treville、Borgo Egnazia
 * vibe：奢華但鬆弛、橄欖樹下蔚藍午後、晒太陽的安靜
 *
 * 配色（強制、勿改）：
 *   #F4E9D8 奶油沙（背景）
 *   #D9B382 陽光金（強調）
 ...
 *   - 嚴格 8pt grid
 *   - 不用 lorem ipsum、所有文案皆扣回角落品牌真實可信
 */
...
export default function MediterraneanSunDemo() {
